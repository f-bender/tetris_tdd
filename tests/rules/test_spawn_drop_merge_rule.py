...
def test_drop_triggered_on_correct_frames() -> None:
    ...
    assert_whether_drop_triggered_after(drop_rule, frame_counter=14, quick_drop_held_since= 1, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=15, quick_drop_held_since= 2, should_trigger= True)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=16, quick_drop_held_since= 3, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=17, quick_drop_held_since= 4, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=18, quick_drop_held_since= 5, should_trigger= True)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=19, quick_drop_held_since= 6, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=20, quick_drop_held_since= 7, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=21, quick_drop_held_since= 8, should_trigger= True)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=22, quick_drop_held_since= 9, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=23, quick_drop_held_since=10, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=24, quick_drop_held_since=11, should_trigger= True)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=25, quick_drop_held_since=12, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=26, quick_drop_held_since=13, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=27, quick_drop_held_since=14, should_trigger= True)
    ...
    assert_whether_drop_triggered_after(drop_rule, frame_counter=30, quick_drop_held_since= 0, should_trigger=False)
    ...
    assert_whether_drop_triggered_after(drop_rule, frame_counter=33, quick_drop_held_since= 0, should_trigger= True)
    ...
    assert_whether_drop_triggered_after(drop_rule, frame_counter=36, quick_drop_held_since= 0, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=37, quick_drop_held_since= 0, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=38, quick_drop_held_since= 0, should_trigger=False)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=39, quick_drop_held_since= 0, should_trigger= True)
    assert_whether_drop_triggered_after(drop_rule, frame_counter=40, quick_drop_held_since= 0, should_trigger=False)
    # fmt: on
